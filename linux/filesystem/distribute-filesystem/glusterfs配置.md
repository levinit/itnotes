...
do
  ...
  ssh $node "mkdir -p /storage/brick1/vol"  #创建brick目录
done
gluster pool list
...
gluster v create <volname> disperse 3 redundancy 1 io1.ib:/storage/brick1/vol io2.ib:/storage/brick1/vol io3.ib:/storage/brick1/vol
