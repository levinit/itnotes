...
fortune_gushici() {
	...
	#FORTUNE_DIR=$(fortune -f 2>&1|head -n 1|awk '{print $NF}')
	mkdir -p $FORTUNE_DIR
	git clone --depth 1 https://github.com/levinit/fortune-zh-gushici.git /tmp/fortune-gushici && cp /tmp/fortune-gushici/data/gushici* $FORTUNE_DIR
}
