...
```cmd
PowerShell -Command "New-NetFirewallRule -DisplayName 'WSL' -Direction Inbound  -InterfaceAlias 'vEthernet (WSL)'  -Action Allow " > C:\Users\CHJS\Documents\apps\wsl-to-host.log
```
